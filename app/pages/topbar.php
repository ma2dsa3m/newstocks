                        ...
                        <form class="m-header-search__form" method="post">
                            <div class="m-header-search__wrapper">
                                ...
                                <span class="m-header-search__input-wrapper">
												<input autocomplete="on" type="text" name="ticket" class="m-header-search__input" value="<?php echo strtolower(@$ticker)?>" placeholder="Input Ticker...." id="m_quicksearch_input" autofocus>
											</span>
